        ...
        public List<Local> Locais()
        {
            List<Local> locais = new()
            {
              //  new Local(0, "Predio Principal Entrada") { LatitudeMin = 00, LongitudeMin = 00, LatitudeMax = 00, LongitudeMax = 00, LatitudeEntrada = 00, LongitudeEntrada = 00, Pisoo = 1, AndarId = 0},
                new Local(1, "Secretaria Veteranos")     { LatitudeMin = 03, LongitudeMin = 01, LatitudeMax = 09, LongitudeMax = 05, LatitudeEntrada = 05, LongitudeEntrada = 05, Pisoo = 1, AndarId = 0},
                ...
                new Local(3, "Cafeteria Expresso")       { LatitudeMin = 17, LongitudeMin = 01, LatitudeMax = 28, LongitudeMax = 04, LatitudeEntrada = 26, LongitudeEntrada = 04, Pisoo = 1, AndarId = 0},
                ...
                new Local(6, "Laboratório")              { LatitudeMin = 19, LongitudeMin = 09, LatitudeMax = 27, LongitudeMax = 13, LatitudeEntrada = 27, LongitudeEntrada = 11, Pisoo = 1, AndarId = 0},

                new Local(9, "Secretaria 2")             { LatitudeMin = 01, LongitudeMin = 01, LatitudeMax = 06, LongitudeMax = 10, LatitudeEntrada = 06, LongitudeEntrada = 08, Pisoo = 2, AndarId = 1},
                ...
                new Local(11, "Cafeteria 2")             { LatitudeMin = 22, LongitudeMin = 01, LatitudeMax = 28, LongitudeMax = 10, LatitudeEntrada = 22, LongitudeEntrada = 03, Pisoo = 2, AndarId = 1},
